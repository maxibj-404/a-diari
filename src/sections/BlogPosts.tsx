...
const pieces: Piece[] = [
  ...
  { id: 7, title: 'Pràctica 7', titleES: 'Práctica 7', titleEN: 'Practice 7', titleFR: 'Pratique 7', description: 'Quarta pràctica de fresadora. Treball amb diferents materials.', descriptionES: 'Cuarta práctica de fresadora. Trabajo con diferentes materiales.', descriptionEN: 'Fourth milling practice. Working with different materials.', descriptionFR: 'Quatrième pratique de fraiseuse. Travail avec différents matériaux.', date: '2025-11-13', tags: ['Fresadora'], images: ['/pieza7.jpg'] },
  { id: 8, title: 'Pràctica 8', titleES: 'Práctica 8', titleEN: 'Practice 8', titleFR: 'Pratique 8', description: 'Primera pràctica manual. Treball manual amb eines.', descriptionES: 'Primera práctica manual. Trabajo manual con herramientas.', descriptionEN: 'First manual practice. Manual work with tools.', descriptionFR: 'Première pratique manuelle. Travail manuel avec des outils.', date: '2025-11-13', tags: ['Manual'], images: ['/pieza8.jpg'] },
  { id: 9, title: 'Pràctica 9', titleES: 'Práctica 9', titleEN: 'Practice 9', titleFR: 'Pratique 9', description: 'Segona pràctica manual. Projecte amb peces complexes.', descriptionES: 'Segunda práctica manual. Proyecto con piezas complejas.', descriptionEN: 'Second manual practice. Project with complex parts.', descriptionFR: 'Deuxième pratique manuelle. Projet avec pièces complexes.', date: '2025-11-13', tags: ['manual'], images: ['/pieza9.jpg'] },
  { id: 10, title: 'Pràctica 10', titleES: 'Práctica 10', titleEN: 'Practice 10', titleFR: 'Pratique 10', description: 'Cinquena pràctica de fresadora. Acabat final de peces.', descriptionES: 'Quinta práctica de fresadora. Acabado final de piezas.', descriptionEN: 'Fifth milling practice. Final finishing of parts.', descriptionFR: 'Cinquième pratique de fraiseuse. Finition finale des pièces.', date: '2025-11-13', tags: ['Fresadora'], images: ['/pieza10.jpg'] },
