...
import { Wrench, Cpu, MapPin, GraduationCap, Calendar } from 'lucide-react'
  ...
  return (
    <section className="py-20 bg-white dark:bg-[#0f0f1a]">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-4xl font-bold text-[#1a1a2e] dark:text-white mb-4 text-center">{t('about.title')}</h2>
        <p className="text-gray-600 dark:text-gray-400 text-center mb-12 max-w-2xl mx-auto">{t('about.p1')}</p>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-2 md:order-1">
              <div className="bg-gradient-to-br from-[#1a1a2e] to-[#0f3460] rounded-2xl p-8 shadow-xl">
                <h3 className="text-2xl font-bold text-white mb-6">{t('about.devTitle')}</h3>
        ...
        {activeTab === 'digital' && (
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-2 md:order-1">
              <div className="bg-gradient-to-br from-[#1a1a2e] to-[#0f3460] rounded-2xl p-8 shadow-xl">
                <h3 className="text-2xl font-bold text-white mb-6">{t('about.digitalTitle')}</h3>
                <div className="space-y-4 text-white/80">
                ...
                <div className="mt-6 pt-6 border-t border-white/20 grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-3 text-white/80">
                    <GraduationCap size={18} className="text-[#e94560]" />
                    <span>CFGS</span>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 md:order-2">
              <div className="bg-gradient-to-br from-[#e94560]/20 to-[#0f3460]/20 rounded-2xl p-8 border border-[#e94560]/20">
                <h4 className="text-xl font-bold text-[#1a1a2e] dark:text-white mb-4">{t('about.skills')}</h4>
                <ul className="space-y-3">
                  {['CAD Design', 'CNC Programming', 'CAM Software', '3D Modeling'].map(skill => (
                    <li key={skill} className="flex items-center gap-2 text-gray-600 dark:text-gray-300">
                      <span className="w-2 h-2 bg-[#e94560] rounded-full" /> {skill}
                    </li>
                  ))}
                </ul>
              </div>
