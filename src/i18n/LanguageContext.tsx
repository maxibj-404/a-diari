...
const translations: Record<Language, Translations> = {
  ca: {
    ...
    blog: { title: 'Les meves pràctiques', subtitle: 'Projectes i treballs del taller', readMore: 'Llegir més', rssFeed: 'RSS', all: 'Tots', lathe: 'Torno', milling: 'Fresadora', welding: 'Soldadura', manual: 'Manual', showMore: 'Veure més', showLess: 'Veure menys' },
  ...
  es: {
    ...
    blog: { title: 'Mis prácticas', subtitle: 'Proyectos y trabajos del taller', readMore: 'Leer más', rssFeed: 'RSS', all: 'Todos', lathe: 'Torno', milling: 'Fresadora', welding: 'Soldadura', manual: 'Manual', showMore: 'Ver más', showLess: 'Ver menos' },
  ...
  en: {
    ...
    blog: { title: 'My practices', subtitle: 'Projects and workshop work', readMore: 'Read more', rssFeed: 'RSS', all: 'All', lathe: 'Lathe', milling: 'Milling', welding: 'Welding', manual: 'Manual', showMore: 'Show more', showLess: 'Show less' },
  ...
  fr: {
    ...
    blog: { title: 'Mes pratiques', subtitle: 'Projets et travaux d\'atelier', readMore: 'Lire la suite', rssFeed: 'RSS', all: 'Tous', lathe: 'Tour', milling: 'Fraiseuse', welding: 'Souduer', manual: 'Manuel', showMore: 'Voir plus', showLess: 'Voir moins' },
