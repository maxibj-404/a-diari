...
const translations: Record<Language, Translations> = {
  ca: {
    nav: { home: 'Inici', practices: 'Pràctiques', about: 'Qui sóc?', contact: 'Contacte', license: 'Llicència' },
    ...
    blog: { title: 'Les meves pràctiques', subtitle: 'Projectes i treballs del taller', readMore: 'Llegir més', rssFeed: 'RSS', all: 'Tots', lathe: 'Torno', milling: 'Fresadora', welding: 'Soldadura', manual: 'Manual', croquis: 'Croquis', showMore: 'Veure més', showLess: 'Veure menys' },
  ...
  es: {
    nav: { home: 'Inicio', practices: 'Prácticas', about: 'Quién soy?', contact: 'Contacto', license: 'Licencia' },
    ...
    blog: { title: 'Mis prácticas', subtitle: 'Proyectos y trabajos del taller', readMore: 'Leer más', rssFeed: 'RSS', all: 'Todos', lathe: 'Torno', milling: 'Fresadora', welding: 'Soldadura', manual: 'Manual', croquis: 'Croquis', showMore: 'Ver más', showLess: 'Ver menos' },
  ...
  en: {
    nav: { home: 'Home', practices: 'Practices', about: 'About', contact: 'Contact', license: 'License' },
    ...
    blog: { title: 'My practices', subtitle: 'Projects and workshop work', readMore: 'Read more', rssFeed: 'RSS', all: 'All', lathe: 'Lathe', milling: 'Milling', welding: 'Welding', manual: 'Manual', croquis: 'Sketching', showMore: 'Show more', showLess: 'Show less' },
  ...
  fr: {
    nav: { home: 'Accueil', practices: 'Pratiques', about: 'À propos', contact: 'Contact', license: 'Licence' },
    ...
    blog: { title: 'Mes pratiques', subtitle: 'Projets et travaux d\'atelier', readMore: 'Lire la suite', rssFeed: 'RSS', all: 'Tous', lathe: 'Tour', milling: 'Fraiseuse', welding: 'Souduer', manual: 'Manuel', croquis: 'Croquis', showMore: 'Voir plus', showLess: 'Voir moins' },
